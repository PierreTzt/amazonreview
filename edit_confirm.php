...
//{
//    $resale = $_POST["resale"];
    $db = App::getDatabase()->query("UPDATE products SET name = '$name', purchase_date = '$purchase_date', review_date = '$review_date', price = '$price', url = '$url', expectancy ='$expectancy', refund_type = '$refund_type', seller_name = '$seller_name', seller_url = '$seller_url', condition = '$_condition' WHERE id = $id");
//}
//else{
