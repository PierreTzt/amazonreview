	...
	<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
			...
			<div class="page-title d-flex flex-column me-3">
				<!--begin::Title-->
				<h1 class="d-flex text-white fw-bolder my-1 fs-3">Details de la commande</h1>
				<!--end::Title-->
			<!--begin::Breadcrumb-->
			<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
				...
				<!--end::Item-->
				<!--begin::Item-->
					<li class="breadcrumb-item text-white opacity-75">Details de la commande</li>
				<!--end::Item-->
				</ul>
				<!--end::Breadcrumb-->
			</div>
			<!--end::Page title-->
				...
				<div class="d-flex align-items-center py-3 py-md-1">
					<!--begin::Button-->
					<a href="edit_order.php?id=<?php echo $id; ?>" class="btn btn-bg-white btn-active-color-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app" id="kt_toolbar_primary_button">Modifier la commande</a>
					<!--end::Button-->
				</div>
				<!--end::Actions-->
			</div>
							...
							<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3 mb-1">Informations sur la commande</span>
											</h3>
										</div>
										<!--end::Header-->
										<!--begin::Body-->
