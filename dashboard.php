									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												...
												<span class="text-muted mt-1 fw-bold fs-7">Voici vos 5 dernieres commandes</span>
											</h3>
												...
												<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
													...
													<thead>
														<tr class="fw-bolder text-muted">
															...
															<th class="min-w-150px">Nom du produits</th>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bolder text-hover-primary fs-6">commande 7</a>
																		<span class="text-muted fw-bold text-muted d-block fs-7">Lien du produits</span>
																	</div>
																</div>
															</td>
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">19.99€</a>
																<span class="text-muted fw-bold text-muted d-block fs-7">Remboursement total</span>
															</td>
															<td class="text-end">
																<div class="d-flex flex-column w-100 me-2">
																	<div class="d-flex flex-stack mb-2">
																		<span class="text-muted me-2 fs-7 fw-bold">Recu</span>
																	</div>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bolder text-hover-primary fs-6">commande 6</a>
																		<span class="text-muted fw-bold text-muted d-block fs-7">Lien du produits</span>
																	</div>
																</div>
															</td>
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">19.99€</a>
																<span class="text-muted fw-bold text-muted d-block fs-7">Remboursement partiel</span>
															</td>
															<td class="text-end">
																<div class="d-flex flex-column w-100 me-2">
																	<div class="d-flex flex-stack mb-2">
																		<span class="text-muted me-2 fs-7 fw-bold">Remboursé</span>
																	</div>
																	<div class="progress h-6px w-100">
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bolder text-hover-primary fs-6">Casque gamer</a>
																		<span class="text-muted fw-bold text-muted d-block fs-7">Lien du produits</span>
																	</div>
																</div>
															</td>
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">34.90€</a>
																<span class="text-muted fw-bold text-muted d-block fs-7">Rembousement partiel</span>
															</td>
															<td class="text-end">
																<div class="d-flex flex-column w-100 me-2">
																	<div class="d-flex flex-stack mb-2">
																		<span class="text-muted me-2 fs-7 fw-bold">Renvoyé</span>
																	</div>
																	<div class="progress h-6px w-100">
																		<div class="progress-bar bg-success" role="progressbar" style="width: 00%" aria-valuenow="00" aria-valuemin="0" aria-valuemax="100"></div>
																	</div>
																</div>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bolder text-hover-primary fs-6">Commande 4</a>
																		<span class="text-muted fw-bold text-muted d-block fs-7">Lien du produits</span>
																	</div>
																</div>
															</td>
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">9.90€</a>
																<span class="text-muted fw-bold text-muted d-block fs-7">Rembousement total</span>
															</td>
															<td class="text-end">
																<div class="d-flex flex-column w-100 me-2">
																	<div class="d-flex flex-stack mb-2">
																		<span class="text-muted me-2 fs-7 fw-bold">Commandé</span>
																	</div>
																	<div class="progress h-6px w-100">
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bolder text-hover-primary fs-6">Commande 3</a>
																		<span class="text-muted fw-bold text-muted d-block fs-7">Lien du produits</span>
																	</div>
																</div>
															</td>
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">19.90€</a>
																<span class="text-muted fw-bold text-muted d-block fs-7">Remboursement total</span>
															</td>
															<td class="text-end">
																<div class="d-flex flex-column w-100 me-2">
